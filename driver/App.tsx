...
startAt = "login", onBackToCustomer}: {startAt?: "welcome" | "login"; onBackToCustomer?: () => void} = {}) {
        ...
        <View style={styles.bottomNav}>
          {items.map(([key,icon,label])=>(
            <Pressable key={key} style={[styles.navItem,active===key&&styles.navItemActive]}
              onPress={()=>setScreen(key as DriverScreen)}>
  ...
  function ServiceModeScreen() {
    ...
    const modes: Array<{
      ...
      ...(hasRickshaw ? [{id:"PASSENGER" as const,title:"Passenger + Parcel",subtitle:"Passenger rides and eligible Parcel delivery",icon:"passenger_service",bg:"#EAF8F1",checks:["Full / Shared / Connection rides","Parcel delivery","E-Rickshaw only"]}] : []),
      ...
      ...(hasRickshaw && hasPickup ? [{id:"BOTH" as const,title:"Both Services",subtitle:"Receive Passenger/Parcel + Goods requests",icon:"both_services",bg:"#FFF5E4",checks:["Use both eligible vehicles","Flexible work options","More requests"]}] : [])
    ];
...
const styles = StyleSheet.create({
  ...
  bottomNav:{position:"absolute",left:0,right:0,bottom:0,flexDirection:"row",backgroundColor:"#fff",borderTopWidth:1,borderTopColor:"#E8EDF3",paddingTop:8,paddingBottom:8},
