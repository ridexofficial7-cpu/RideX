...
-- RideX v5.8 additions missing from the previous baseline.
ALTER TABLE "Booking" ADD COLUMN "requestedDurationMinutes" INTEGER;
ALTER TABLE "Booking" ADD COLUMN "serviceSubtype" TEXT;
ALTER TABLE "Booking" ADD COLUMN "environment" TEXT NOT NULL DEFAULT 'TEST';
ALTER TABLE "Booking" ADD COLUMN "pickupZoneId" TEXT;
ALTER TABLE "Booking" ADD COLUMN "dropZoneId" TEXT;
ALTER TABLE "Booking" ADD COLUMN "sharedGroupId" TEXT;

ALTER TABLE "BookingLeg" ADD COLUMN "verificationMethod" TEXT NOT NULL DEFAULT 'OTP';
ALTER TABLE "BookingLeg" ADD COLUMN "verificationTokenHash" TEXT;
ALTER TABLE "BookingLeg" ADD COLUMN "verificationExpiresAt" TIMESTAMP(3);
ALTER TABLE "BookingLeg" ADD COLUMN "verificationUsedAt" TIMESTAMP(3);
ALTER TABLE "BookingLeg" ADD COLUMN "verificationCustomerId" TEXT;
ALTER TABLE "BookingLeg" ADD COLUMN "verificationDriverId" TEXT;
ALTER TABLE "BookingLeg" ADD COLUMN "handoverStatus" TEXT NOT NULL DEFAULT 'NOT_REQUIRED';
ALTER TABLE "BookingLeg" ADD COLUMN "maxDistanceKm" DOUBLE PRECISION;
ALTER TABLE "BookingLeg" ADD COLUMN "connectionPointZoneId" TEXT;
ALTER TABLE "BookingLeg" ADD COLUMN "handoverFromDriverId" TEXT;
ALTER TABLE "BookingLeg" ADD COLUMN "handoverToDriverId" TEXT;
ALTER TABLE "BookingLeg" ADD COLUMN "handoverAt" TIMESTAMP(3);
...
ALTER TABLE "CityZone" ADD CONSTRAINT "CityZone_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "PricingRule_service_vehicle_active_idx" ON "PricingRule"("serviceType","vehicleType","active");
...
ALTER TABLE "ParcelItem" ADD CONSTRAINT "ParcelItem_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "ParcelItem_booking_sequence_idx" ON "ParcelItem"("bookingId","sequence");
...
ALTER TABLE "BookingShareMember" ADD CONSTRAINT "BookingShareMember_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "BookingShareMember_booking_status_idx" ON "BookingShareMember"("bookingId","status");
...
ALTER TABLE "ApprovedTester" ADD CONSTRAINT "ApprovedTester_pkey" PRIMARY KEY ("id");
ALTER TABLE "ApprovedTester" ADD CONSTRAINT "ApprovedTester_mobile_key" UNIQUE ("mobile");
...
ALTER TABLE "EnvironmentControl" ADD CONSTRAINT "EnvironmentControl_pkey" PRIMARY KEY ("id");
ALTER TABLE "EnvironmentControl" ADD CONSTRAINT "EnvironmentControl_key_key" UNIQUE ("key");
...
ALTER TABLE "ProjectRelease" ADD CONSTRAINT "ProjectRelease_pkey" PRIMARY KEY ("id");
ALTER TABLE "ProjectRelease" ADD CONSTRAINT "ProjectRelease_version_key" UNIQUE ("version");
CREATE INDEX "ProjectRelease_environment_status_created_idx" ON "ProjectRelease"("environment","status","createdAt");
...
ALTER TABLE "TestRun" ADD CONSTRAINT "TestRun_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "TestRun_status_started_idx" ON "TestRun"("status","startedAt");
...
ALTER TABLE "DataMergeJob" ADD CONSTRAINT "DataMergeJob_pkey" PRIMARY KEY ("id");
CREATE INDEX "DataMergeJob_status_created_idx" ON "DataMergeJob"("status","createdAt");

CREATE INDEX "Booking_environment_sharedGroup_idx" ON "Booking"("environment","sharedGroupId");
CREATE INDEX "Booking_zone_pair_idx" ON "Booking"("pickupZoneId","dropZoneId","status");
CREATE INDEX "BookingLeg_handover_idx" ON "BookingLeg"("handoverToDriverId","status");
