...
const ADMIN_NAME = "Ravi jha";
const ADMIN_MOBILE = "7870110360";
...
const PERMISSIONS: Array<[string, PermissionAction, string]> = [
  ...
  ["coupons", PermissionAction.VIEW, "View coupons"],
  ["coupons", PermissionAction.CREATE, "Create coupons"],
  ["coupons", PermissionAction.EDIT, "Edit, activate and deactivate coupons"],
];

async function main() {
  console.log("RideX initial Super Admin bootstrap...");
  console.log(`Name: ${ADMIN_NAME}`);
  console.log(`Mobile: +91 ${ADMIN_MOBILE}`);
