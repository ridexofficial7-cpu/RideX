...
export default function App() {
  ...
  function ServiceModeScreen() {
    const modes = [
      ["PASSENGER","Passenger Rides","Carry passengers with your E-Rickshaw","🚕","#EAF8F1",["Regular rides in your area","Shared & connecting rides","More ride opportunities"]],
      ["GOODS","Goods Availability","Battery Pickup Truck • Goods only","🛻","#F1ECFF",["Goods only","Duration booking","No passenger / parcel"]],
      ["BOTH","Both (Passenger + Goods)","Receive both passenger and goods ride requests","▱","#FFF5E4",["Maximize your earnings","Flexible work options","More requests, less waiting"]]
    ] as const;
