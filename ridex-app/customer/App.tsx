      ...
      <ScreenShell>
        ...
        <View style={s.modeToggle}>
          ...
          <Pressable style={[s.modeToggleItem, s.modeActive]}>
            <Text style={s.modeIcon}>{goodsType === "Parcel Delivery" ? "📦" : "🛻"}</Text>
        ...
        {goodsType === "Parcel Delivery" ? (
          ...
          <>
            ...
            <GoodsOption selected icon="🛻" title="Battery Pickup Truck" subtitle="Goods only • no passenger / parcel" meta="Dedicated goods vehicle" fare="Duration + distance rules" onPress={() => {}} />
